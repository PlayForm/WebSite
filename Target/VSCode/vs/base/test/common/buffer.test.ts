	...
	suite("encoding", () => {
		...
		*/
		...
		const testCases: [Uint8Array, base64: string, hex: string][] = [
			...
			[
				new Uint8Array([96, 54, 130, 79, 47, 179]),
				"YDaCTy+z",
				"6036824f2fb3",
			],
			[
			...
			[
				new Uint8Array([
					152, 131, 106, 234, 17, 183, 164, 245, 252, 67, 26,
				]),
				"mINq6hG3pPX8Qxo=",
			...
			[
				new Uint8Array([
					232, 254, 194, 234, 16, 42, 86, 135, 117, 61, 179, 4,
				]),
				"6P7C6hAqVod1PbME",
			...
			[
				new Uint8Array([
					189, 67, 62, 189, 87, 171, 27, 164, 87, 142, 126, 113, 23,
					182,
				]),
				"vUM+vVerG6RXjn5xF7Y=",
			...
			[
				new Uint8Array([
					153, 156, 145, 240, 228, 200, 199, 158, 40, 167, 97, 52,
					217, 148, 43,
				]),

...
suite("OAuth", () => {
	...
	suite("Type Guards", () => {
		test("isAuthorizationProtectedResourceMetadata should correctly identify protected resource metadata", () => {
			...
			// Invalid cases
			assert.strictEqual(
				isAuthorizationProtectedResourceMetadata(null),
				false,
			);
			assert.strictEqual(
		...
		test("isAuthorizationServerMetadata should correctly identify server metadata", () => {
			...
			assert.strictEqual(
				isAuthorizationServerMetadata("not an object"),
				false,
			);
		});
		...
		test("isAuthorizationAuthorizeResponse should correctly identify authorization response", () => {
			...
			assert.strictEqual(
				isAuthorizationAuthorizeResponse(undefined),
				false,
			);
		...
		test("isAuthorizationTokenResponse should correctly identify token response", () => {
			...
			assert.strictEqual(
				isAuthorizationTokenResponse("not an object"),
				false,
			);
		});
		...
		test("isDynamicClientRegistrationResponse should correctly identify client registration response", () => {
			...
			// Invalid cases
			assert.strictEqual(
				isDynamicClientRegistrationResponse(null),
				false,
			);
			assert.strictEqual(
				isDynamicClientRegistrationResponse(undefined),
				false,
			);
			...
			assert.strictEqual(
				isDynamicClientRegistrationResponse("not an object"),
				false,
			);
		});
		...
		test("isAuthorizationDeviceResponse should correctly identify device authorization response", () => {
			...
			assert.strictEqual(
				isAuthorizationDeviceResponse({
					verification_uri: "missing-others",
				}),
				false,
			);
			assert.strictEqual(
			...
			assert.strictEqual(
				isAuthorizationDeviceResponse("not an object"),
				false,
			);
		});
		...
		test("isAuthorizationDeviceTokenErrorResponse should correctly identify device token error response", () => {
			...
			// Invalid cases
			assert.strictEqual(
				isAuthorizationDeviceTokenErrorResponse(null),
				false,
			);
			assert.strictEqual(
				isAuthorizationDeviceTokenErrorResponse(undefined),
				false,
			);
			assert.strictEqual(
				isAuthorizationDeviceTokenErrorResponse({}),
			...
			assert.strictEqual(
				isAuthorizationDeviceTokenErrorResponse("not an object"),
				false,
			);
		});
	});

...
(async function () {
	...
	type ISandboxConfiguration = import(
		"../../../base/parts/sandbox/common/sandboxTypes.js",
	).ISandboxConfiguration;
	type ILoadResult<M, T extends ISandboxConfiguration> = import(
		"../../../platform/window/electron-sandbox/window.js",
	).ILoadResult<M, T>;
	type ILoadOptions<T extends ISandboxConfiguration> = import(
		"../../../platform/window/electron-sandbox/window.js",
	).ILoadOptions<T>;
	type INativeWindowConfiguration = import(
		"../../../platform/window/common/window.ts",
	).INativeWindowConfiguration;
	type IMainWindowSandboxGlobals = import(
		"../../../base/parts/sandbox/electron-sandbox/globals.js",
	).IMainWindowSandboxGlobals;
	type IDesktopMain = import(
		"../../../workbench/electron-sandbox/desktop.main.js",
	).IDesktopMain;
		...
		if (data?.layoutInfo) {
			...
			if (layoutInfo.windowBorder && colorInfo.windowBorder) {
				...
				if (layoutInfo.windowBorderRadius) {
					borderElement.style.borderRadius =
						layoutInfo.windowBorderRadius;
				}

...
export class NativeEditContext extends AbstractEditContext {
	...
	private _emitTypeEvent(
		...
		if (
			!this._editContextPrimarySelection.equalsSelection(
				this._primarySelection,
			)
		) {
			return;
	...
	private _getNewEditContextState():
		...
		const primarySelectionEndLine =
			editContextPrimarySelection.endLineNumber;
		...
		const selectionStartOffset =
			editContextPrimarySelection.startColumn - 1;

...
export class InlineCompletionsHintsWidget extends Disposable {
	...
	constructor(
		...
		this.alwaysShowToolbar = observableFromEvent(
			...
			() =>
				this.editor.getOption(EditorOption.inlineSuggest)
					.showToolbar === "always",
		);
	...
	implements IContentWidget
{
	...
	constructor(
		...
		private readonly _warning: IObservable<
			InlineCompletionWarning | undefined
		>,
		...
		this._warningMessageContentNode = derived((reader) => {
			...
			const markdownElement = reader.store.add(

	...
	implements IInlineEditsView
{
	...
	constructor(
		...
		this._hoverableElement =
			observableValue<ObserverNodeWithElement | null>(this, null);
		this.isHovered = this._hoverableElement.map(
		...
		this._layout = derived(this, (reader) => {
			...
			const modifiedOffset = new Point(
				modifiedLeftOffset,
				modifiedTopOffset,
			);

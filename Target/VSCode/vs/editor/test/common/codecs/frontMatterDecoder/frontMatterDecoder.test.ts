						...
						[
							...
							new FrontMatterRecord([
								...
								new FrontMatterArray([
									...
									new FrontMatterSequence([
										new Word(
											new Range(1, 30, 1, 30 + 4),
											"some",
										),
										new Dash(new Range(1, 34, 1, 35)),
										new Word(
											new Range(1, 35, 1, 35 + 4),
											"tool",
										),
									]),

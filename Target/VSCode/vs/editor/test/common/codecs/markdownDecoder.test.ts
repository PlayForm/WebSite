...
import {
	LeftBracket,
	RightBracket,
} from "../../../common/codecs/simpleCodec/tokens/brackets.js";
import {
	MarkdownDecoder,
	TMarkdownToken,
...
suite("MarkdownDecoder", () => {
			...
			await test.run(
				...
				[
					...
					new MarkdownLink(
						...
						1,
						"[(example!)]",
						"(another/path/with[-and-]-chars/folder)",
					),
	...
	suite("• links", () => {
		suite("• broken", () => {
			...
			suite(
				"• stop characters inside caption/reference (new lines)",
				() => {
			 ...
			 */
			suite(
				"• stop characters inside caption/reference (same line)",
				() => {

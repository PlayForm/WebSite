...
suite("Configuration.Parse", () => {
	...
	test("parsing configuration only with local user configuration and raw is same", () => {
		...
		assert.deepStrictEqual(
			actual.inspect("a", { overrideIdentifier: "x" }, undefined)
				.userLocal,
			{
				value: 1,
				override: 2,
		...
		assert.deepStrictEqual(
			actual.inspect("b", { overrideIdentifier: "x" }, undefined)
				.userLocal,
			{
				value: undefined,
				override: 1,
		...
		assert.deepStrictEqual(
			actual.inspect("d", {}, undefined).user,
			undefined,
		);
	});
	...
	test("parsing configuration only with local user configuration and raw is not same", () => {
		...
		assert.deepStrictEqual(
			actual.inspect("e", {}, undefined).user,
			undefined,
		);
	});
	...
	test("parsing configuration with local and remote user configuration and raw is same for both", () => {
		...
		assert.deepStrictEqual(
			actual.inspect("b", { overrideIdentifier: "y" }, undefined)
				.userLocal,
			undefined,
		);
		assert.deepStrictEqual(
		...
		assert.deepStrictEqual(
			actual.inspect("c", {}, undefined).user,
			undefined,
		);
	});

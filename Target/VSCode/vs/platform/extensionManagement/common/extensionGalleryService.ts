	...
	implements IExtensionGalleryService
{
	...
	constructor(
		...
		this.extensionsControlUrl =
			productService.extensionsGallery?.controlUrl;
	...
	private async getRawGalleryExtensionVersion(
		...
		const version = isString(criteria.version)
			? criteria.version
			: undefined;
					...
					if (
						await this.isValidVersion(
							...
							},
							{
								...
								version:
									onlyCompatible?.version ?? version.version,
							},

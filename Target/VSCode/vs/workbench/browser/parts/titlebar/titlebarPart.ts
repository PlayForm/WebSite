			...
			this.instantiationService.createInstance(
				...
				this.actionToolBarElement,
				{
					...
					highlightToggledItems:
						this.editorActionsEnabled || this.isAuxiliary, // Only show toggled state for editor actions or auxiliary title bars
	...
	private createActionToolBarMenus(
		...
		if (update.editorActions) {
			...
			if (
				...
				this.actionToolBar.actionRunner =
					this.editorToolbarMenuDisposables.add(new ActionRunner());
		...
		if (update.globalActions) {
			...
			if (this.globalActionsEnabled) {
				...
				this.globalToolbarMenuDisposables.add(
					this.globalToolbarMenu.onDidChange(() =>
						updateToolBarActions(),
					),
				);
			} else {
	...
	private get editorActionsEnabled(): boolean {
		return (
			...
			(this.editorGroupsContainer.partOptions.editorActionsLocation ===
				...
				this.editorGroupsContainer.partOptions.showTabs ===
					EditorTabsMode.NONE)
		);
	}

	...
	implements IWorkbenchContribution
{
	...
	private _registerActions(): void {
		...
		this._register(
			registerAction2(ManageTrustedMcpServersForAccountAction),
		);
		this._register(
			registerAction2(ManageAccountPreferencesForMcpServerAction),
		);
		this._register(
			registerAction2(RemoveDynamicAuthenticationProvidersAction),
		);
	}

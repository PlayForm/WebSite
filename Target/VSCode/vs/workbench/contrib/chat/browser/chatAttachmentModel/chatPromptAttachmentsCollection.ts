...
export function isPromptFileChatVariable(
	...
	return (
		isChatRequestFileEntry(variable) &&
...
export class ChatPromptAttachmentsCollection extends Disposable {
	 ...
	 */
	protected _onRemove = this._register(
		new Emitter<ChatPromptAttachmentModel>(),
	);
	/**
	...
	public add(uris: URI | readonly URI[]) {
		...
		for (const uri of uriList) {
			...
			const instruction = this.instantiationService.createInstance(

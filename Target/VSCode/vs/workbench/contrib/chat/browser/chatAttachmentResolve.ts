...
export async function resolveEditorAttachContext(
	...
	if (imageContext) {
		return extensionService.extensions.some((ext) =>
...
async function resolveUntitledEditorAttachContext(
...
export async function resolveResourceAttachContext(
	resource: URI,
	isDirectory: boolean,
	textModelService: ITextModelService,
): Promise<IChatRequestVariableEntry | undefined> {
...
export async function resolveImageEditorAttachContext(
	fileService: IFileService,
	dialogService: IDialogService,
	resource: URI,
	data?: VSBuffer,
...
export async function resolveImageAttachContext(
...
export function resolveMarkerAttachContext(
...
export function resolveSymbolsAttachContext(
...
export function resolveNotebookOutputAttachContext(

	...
	implements IModifiedFileEntry
{
	...
	readonly entryId =
		`${AbstractChatEditingModifiedFileEntry.scheme}::${++AbstractChatEditingModifiedFileEntry.lastEntryId}`;
	...
	protected readonly _waitsForLastEdits = observableValue<boolean>(
		this,
		false,
	);
	...
	readonly lastModifyingResponse: IObservable<
		IChatResponseModel | undefined
	...
	protected readonly _userEditScheduler = this._register(
		new RunOnceScheduler(() => this._notifyAction("userModified"), 1000),
	);
	...
	constructor(
		...
		this._store.add(
			autorun((r) => {
				const inProgress =
					this._lastModifyingResponseInProgressObs.read(r);

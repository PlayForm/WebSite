...
export namespace ChatContextKeys {
	...
	export const isRequestPaused = new RawContextKey<boolean>(
		"chatRequestIsPaused",
		false,
		{
			type: "boolean",
	...
	export const canRequestBePaused = new RawContextKey<boolean>(
	...
	export const hasPromptFile = new RawContextKey<boolean>(
		"chatPromptFileAttached",
		false,
		{
			type: "boolean",
			description: localize(
				"chatPromptFileAttachedContextDescription",
				"True when the chat has a prompt file attached.",
			),
		},
	);
	export const chatMode = new RawContextKey<ChatMode>(
		"chatMode",
		ChatMode.Ask,
		{
			type: "string",
	...
	export const Entitlement = {
		...
		enterprise: new RawContextKey<boolean>(
			"chatPlanEnterprise",
			false,
			true,
	...
	export const Editing = {
		agentModeDisallowed: new RawContextKey<boolean>(
	...
	export const Modes = {
		hasCustomChatModes: new RawContextKey<boolean>(
			...
			false,
			{
				...
				description: localize(
					"chatHasCustomChatModes",
					"True when the chat has custom chat modes available.",
				),
			},
		),
	};

...
export const startEntries: GettingStartedStartEntryContent = [
	...
	},
	{
		...
		description: localize(
			...
			"Create a new workspace with Copilot",
		),
			...
			steps: [
				{
					...
					title: localize(
						"gettingStarted.agentMode.title",
						"Agent mode",
					),
					description: localize(
				...
				},
				{
					...
					title: localize(
						"newgettingStarted.settings.title",
						"Customize every aspect of VS Code",
					),
					description: localize(
						"newgettingStarted.settingsAndSync.description.interpolated",

...
suite("EditorGroupsService", () => {
	...
	test("context key provider", async function () {
		...
		let group1ContextKeyValue =
			group1.scopedContextKeyService.getContextKeyValue(
				rawContextKey.key,
			);
		let group2ContextKeyValue =
			group2.scopedContextKeyService.getContextKeyValue(
				rawContextKey.key,
			);
		...
		group1ContextKeyValue =
			group1.scopedContextKeyService.getContextKeyValue(
				rawContextKey.key,
			);
		group2ContextKeyValue =
			group2.scopedContextKeyService.getContextKeyValue(
				rawContextKey.key,
			);
		...
		const group3ContextKeyValue =
			group3.scopedContextKeyService.getContextKeyValue(
				rawContextKey.key,
			);

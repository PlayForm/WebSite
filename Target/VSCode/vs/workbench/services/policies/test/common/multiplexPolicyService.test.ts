...
suite("MultiplexPolicyService", () => {
	...
	test("no policy", async () => {
		...
		{
			const A =
				policyConfiguration.configurationModel.getValue("setting.A");
			const B =
				policyConfiguration.configurationModel.getValue("setting.B");
			const C =
				policyConfiguration.configurationModel.getValue("setting.C");
			const D =
				policyConfiguration.configurationModel.getValue("setting.D");
			const E =
				policyConfiguration.configurationModel.getValue("setting.E");
